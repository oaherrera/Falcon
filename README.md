Notas para iniciar ejecución:

1. Para poder correr el proyecto es necesario:

1.1 Descargar al local el proyecto desde GIT LAB
1.2 Descargar plugin manager de jmeter y copiarlo en la carpeta de Jmeter: lib/ext
1.3 Despues d elos pasos anteriores se debe instalar los Plugins recomendados por JMETER Manager:
- json-lib
- jemeter-plugins-cmn-jmeter
- cmdrunner
- jpcg-graphs-additional X.X
- jpcg-graphs-basic X.X

Una vez realices los pasos anteriores ya puedes ejecutar el plan de pruebas: Falcon Heavy v 3.0 - Colombia
